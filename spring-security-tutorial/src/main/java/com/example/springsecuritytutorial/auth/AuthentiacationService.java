...
import com.example.springsecuritytutorial.UserRepository;
...
public class AuthentiacationService {
    ...
    public AuthentiacationResponse register(RegisterRequest request) {
        ...
        return AuthentiacationResponse
                       .builder()
                       .token(jwtToken)
                       .build();
    }

    public AuthentiacationResponse authenticate(AuthentitcationRequest request) {
